...
border-violet-700 text-center cursor-pointer group hover:border-violet-400 duration-200"
>
    <div
    ...
    <div class="flex flex-1 justify-between gap-4 items-center">
        <div
         ...
         after:absolute after:top-0 after:h-0 after:right-full after:w-full after:h-full after:bg-white after:duration-200
